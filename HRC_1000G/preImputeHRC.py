...
def get_args():
    ...
    parser.add_argument('-q', '--queue', type=str, default='defq', help='OPTIONAL. Queue on cgemsiii to use to submit jobs.  Defaults to all of the seq queues if not supplied')
